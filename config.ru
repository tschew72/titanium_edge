...
get '/logout' do
 ...
 post '/filer' do
      ...
      userdata.update=(:cloudinaryjson => {:timestamp => ts, :callback => "http://dashy3.herokuapp.com/vendor/cloudinary/cloudinary_cors.html", :signature => sig, :api_key =>"219441847515364"}.to_json)
